...
<html lang="en">
  ...
  <body>
	...
	<h4><strong style="color:purple">2021 Materials Research Society Fall Meeting & Exhibit</strong>, Boston, MA, November 29 - December 2, 2021</h4>
        <ul>
		  <li>Muhammad Usman, Lydia Ogebule, Evgenii Oskolkov, Luis Castaneda, Tatiana V. Timofeeva. <em>“Two metal-organic frameworks based on Sr<sup>2+</sup> and 1,2,4,5-tetrakis(4-carboxyphenyl)benzene linkers”</em></li>		
		  <li>Raul Castaneda, Tatiana Kornilova, Michael Petronis, Tatiana V. Timofeeva. <em>“Stable water-soluble complexes with picolinamidine as solubilizing ligand”</em></li>		  	  
        </ul>
		<div class="spacing"></div>
	...
	<h4><strong style="color:purple">2021 Rocky Mountain Regional Meeting of the American Chemical Society</strong>, Tucson, AZ, October 20-23, 2021</h4>
	  ...
	  <div class="spacing"></div>
        ...
        <ul>
          <li>Michael Chilcote, Y. Lu, H. Wang, F. Yang, E. Johnston-Halperin. <em>“Growth and Ferromagnetic Resonance Characterization of Organic-Based Magnets”</em></li>
		  <li>Abhilasha Dehankar, Ezekiel Johnston-Halperin, Joshua Goldberger, Jessica Winter. <em>“Synthesis and Characterization of Iron Oxide Nanoparticles for 0D-2D patterned Graphene Interfaces”</em></li>
		  <li>Nicolas Scozzaro, Brendan A. McCullian, Simranjeet Singh, Alex Melendez, Erick C. Blomberg, Jyoti Katoch, K.C. Fong, Vidya P. Bhallamudi, Denis V. Pelekhov, P. Chris Hammel. <em>“Direct Measurement of Magnetism in Graphene”</em></li>
		  <li>Logan Wolfel, Boris B. Averkiev, Yulia A. Getmanenko, Tatiana V. Timofeeva. <em>“The Crystal Structure of Three Precursors for Synthesis of Polymethine Dyes”</em></li>
		  <li>James Foster, Yulia A. Getmanenko, Boris B. Averkiev, Tatiana V. Timofeeva. <em>“Mono-, Di, and Tetrabromo Naphthalene Diimides: Single Crystal X-Ray Structural Analysis and Application as Acceptor in Donor-Acceptor Co-Crystals”</em></li>
		  <li>Shabarinath Bejagam, Kathryn Storms, Marina S. Fonari, Jennifer Lindline, Tatiana V. Timofeeva. <em>“Structural Diversity in the Adducts of Glutaric Acid with 2-Aminopyridines”</em></li>
		  <li>Taoguang Qu, Tatiana Timofeeva, Qiang Wei, Jennifer Lindline, Michael Petronis, Boris Averkiev. <em>“Luminescent Tuning via Metal Doping of Zn-BTC Systems”</em></li>	  
		  <li>Michelle Tuineau, Yulia Getmanenko, Raul Castaneda, Boris B. Averkiev, Tatiana V. Timofeeva. <em>“Dithieno[3,2-a:2',3'-c]phenazine as Donors in Co-Crystals Growth with 7,7,8,8–tetracyanoquinodimethanen Derivatives”</em></li>
		  <li>Bianca Valencia, Yulia A. Getmanenko, Boris B. Averkiev, Tatiana V. Timofeeva. <em>“Synthesis of Charge Transfer Co-Crystals Based on Dithiazole[4,5-a:5',4'-c]Phenazine and Tetracyanoquinodimethane”</em></li>
		  <li>Jared Leyba. <em>“Computational Plasmonics Utilizing Open-Source Electromagnetic Solvers for Analysis of Novel Metamaterial Geometries for Concentration of Photonic Energy”</em></li>
	  ...
	  <h3><strong style="color:purple">2015</strong></h3>
	  <div class="spacing"></div>
        ...
        <h4><strong style="color:purple">2015 NM Academy of Science Research Symposium</strong>, Albuquerque, NM, November 14, 2015</h4>
        <ul>
          <li>Xu Wang, Taoguang Qu, Frank Huang, Tatiana Timofeeva, Qiang Wei. <em>"Membrane distillation in water treatment”</em></li>
        </ul>
        <div class="spacing"></div>
		
        <h4><strong style="color:purple">45th Western Regional Meeting of the American Chemical Society</strong>, San Marcos, CA, November 6-8, 2015</h4>
        <ul>
        ...
        <ul>
          <li>Tatiana V. Timofeeva. <em>“Structural Regulation of Luminescent Properties of Porous Metal Organic Frameworks”</em></li>
        </ul>
        <div class="spacing"></div>
      </div>
    </div>
