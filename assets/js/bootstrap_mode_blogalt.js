 ...
 * http://twbs.github.com/bootstrap/javascript.html#tabs
	* This template use custom bootstrap.js file for mCustomScrollbar plugin normal working with tabs 
	* Bootstrap plugin line 1705 bootstrap.js
...
+function ($) { "use strict";
  ...
  $.fn.tab.noConflict = function () {
   ...
   /* TAB DATA-API
  * ============ */
/* custom scroll bar in TAB for working correctly with mCustomScrollbar*/
...
/* Custom includes */	
  $(function () {
    $('body').on('click.tab.data-api', '[data-toggle="tab"], [data-toggle="pill"]', function (e) {
      e.preventDefault()
      $(this).tab('show')
	$(".tab-pane").mCustomScrollbar("destroy");
	  $(".tab-pane.active").mCustomScrollbar("update");  
