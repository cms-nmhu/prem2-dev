  ...
  <body>
    ...
    <div class="container" style="background:white">
      ...
      <div class="col-md-6 col-xs-12" style="margin:0 0 10px 0">
        <img width="100%" src="images/earth-mater-1.jpg">
        <p class="text-center">...</p>
      </div>
      <div class="col-md-6 col-xs-12" style="margin:0 0 10px 0">
        <img width="100%" src="images/earth-mater-2.jpg">
        <p class="text-center">...</p>
      </div>
      <div class="col-md-6 col-xs-12" style="margin:0 0 10px 0">
        <img width="100%" src="images/earth-mater-3.jpg">
        <p class="text-center">...</p>
      </div>
      <div class="col-md-6 col-xs-12" style="margin:0 0 35px 0">
        <img width="100%" src="images/earth-mater-4.jpg">
        <p class="text-center">...</p>
      </div>
    </div>
